...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Case studies",
    description: `${stats.moduleCount} modules and ${stats.topicCount} Design X interview scripts — Drive, YouTube, WhatsApp, and more.`,
  };
}
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-12">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4 font-mono text-xs uppercase tracking-wider">
        ...
        <span>{stats.topicCount} case studies</span>
