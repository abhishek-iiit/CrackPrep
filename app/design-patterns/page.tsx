...
const COURSE = "design-patterns";

export async function generateMetadata(): Promise<Metadata> {
  const stats = getCourseStats(COURSE);
  return {
    title: "Design patterns",
    description: `${stats.moduleCount} groups and ${stats.topicCount} Gang of Four patterns — creational, structural, and behavioral.`,
  };
}
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-12">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-4 font-mono text-xs uppercase tracking-wider">
        <span>{stats.moduleCount} groups</span>
        <span aria-hidden>·</span>
        <span>{stats.topicCount} patterns</span>
